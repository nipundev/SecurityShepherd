...
public class PoorAuthentication extends Activity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    logDetails(
        "My name is Jack Meade, I'm here to kick ass and drink gravy... and I'm all outta gravey!");
  ...
  public void onClick(View arg0) {
    switch (arg0.getId()) {
      ...
      case (R.id.bLogin):
        ...
        Log.d(TAG, "temp pass = " + Forgotton.tempPassVar + "passwordReset = " + passwordReset);
        ...
        if (passwordReset == true) {
          if (CheckName.equals(usernameVar)) {
            ...
            if (CheckPass.equals(tempPass)) {
              Toast loggedIn =
                  Toast.makeText(PoorAuthentication.this, "Logged in!", Toast.LENGTH_LONG);
              loggedIn.show();

              Intent loggedInIntent = new Intent("com.mobshep.PoorAuthentication.Main");
              startActivity(loggedInIntent);
            }

          } else {
            Toast locked =
                Toast.makeText(PoorAuthentication.this, "Invalid Password!", Toast.LENGTH_SHORT);
            locked.show();
          ...
          Toast locked =
              Toast.makeText(
                  PoorAuthentication.this, "You're account has been locked!", Toast.LENGTH_SHORT);
          locked.show();
          break;
        }
        ...
        if (CheckName.contentEquals("") || CheckPass.contentEquals("")) {
          Toast empty =
              Toast.makeText(PoorAuthentication.this, "Empty Fields Detected.", Toast.LENGTH_SHORT);
          empty.show();
        }
        ...
        if ("Jack".equals(CheckName) == false
            ...
            || passwordReset == false) {
          Toast invalid =
              Toast.makeText(PoorAuthentication.this, "Invalid Credentials!", Toast.LENGTH_SHORT);
          invalid.show();
