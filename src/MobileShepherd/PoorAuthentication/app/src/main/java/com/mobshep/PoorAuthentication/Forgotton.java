...
public class Forgotton extends Activity {
  ...
  public void reset(View v) {
    ...
    if (CheckQ1.contentEquals("") || CheckQ2.contentEquals("")) {
      Toast empty = Toast.makeText(Forgotton.this, "Empty Fields Detected.", Toast.LENGTH_SHORT);
      empty.show();
    }
    ...
    if ("Chicken".equalsIgnoreCase(CheckQ1) && "Meade".equalsIgnoreCase(CheckQ2)) {
      ...
      Toast invalid = Toast.makeText(Forgotton.this, "Invalid answers.", Toast.LENGTH_SHORT);
      invalid.show();
    }
  }
