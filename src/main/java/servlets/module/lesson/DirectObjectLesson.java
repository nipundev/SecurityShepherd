...
/**
 * Insecure Direct Object Lesson <br>
 * <br>
...
public class DirectObjectLesson extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(DirectObjectLesson.class);
  ...
  private static String htmlGuest(ResourceBundle bundle) {
    return "<h2 class='title'>"
        + bundle.getString("response.user")
        + ": Guest</h2><table><tr><th>"
        + bundle.getString("response.age")
        + ":</th><td>22</td></tr>"
        + "<tr><th>"
        + bundle.getString("response.address")
        ...
        + ":</th><td>"
        + bundle.getString("response.noMessage")
        + "</td></tr></table>";
  }
